        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
            <div className="p-4 border-b bg-gray-50/50 flex justify-between items-center">
                <div>
                    ...
                    <h3 className="text-sm font-mono font-medium text-gray-700">#{order.id.slice(-8).toUpperCase()}</h3>
                </div>
            ...
            <div className="p-4">
                ...
                <div className="flex justify-between items-end">
                    <div className="text-[11px] text-gray-500">
                        <p><span className="font-medium text-gray-700">Người nhận:</span> {order.customerName}</p>
                        <p><span className="font-medium text-gray-700">Ngày đặt:</span> {order.createdAt?.toDate().toLocaleDateString('vi-VN')}</p>
                    </div>
                    <div className="text-right">
                        <p className="text-xs text-gray-400 uppercase font-bold">Tổng thanh toán</p>
                        <p className="text-xl font-black text-orange-500">{order.totalAmount?.toLocaleString()}đ</p>
                    </div>
                </div>
            </div>
        </div>
